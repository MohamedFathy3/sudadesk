                  ...
                  <div className="bg-purple-50 px-6 py-4 rounded-xl border border-purple-200">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-2xl font-bold text-purple-600">{uniqueSchoolsCount}</p>
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-500">
                                  {classItem.students?.filter(s => Object.keys(s?.attendance_report || {}).length > 0)?.length || 0} with attendance
                                </div>
                              </div>
                            </div>
                          </td>
